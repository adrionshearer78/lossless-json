...
Stringfying `BigInt` values is not possible, unless you want to stringify them into a string with quotes. That is possible by [monkey patching a method `BigInt.prototype.toJSON`](https://github.com/GoogleChromeLabs/jsbi/issues/30#issuecomment-1006088574). However, when parsing this data again, it is not possible to know whether a string that contains an integer number was intended to be a string or a bigint. 
...
// {
//   number: 1.23,
//   long: BigInt(9123372036854000123)
// }
```
